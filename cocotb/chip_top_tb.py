...
"""Chip-level testbench for gf180mcu_ic_1x0p5_sram_u8b9k.
...
hdl_toplevel = "gf180mcu_ic_1x0p5_sram_u8b9k_top"
...
async def test_startup(dut):
    ...
    logger = logging.getLogger("gf180mcu_ic_1x0p5_sram_u8b9k_tb")
...
def chip_top_runner():
    ...
    if gl:
        ...
        sources.append(proj_path / "../src/gf180mcu_ic_1x0p5_sram_u8b9k_top.sv")
        sources.append(proj_path / "../src/gf180mcu_ic_1x0p5_sram_u8b9k_core.sv")
        sources.append(proj_path / "../src/gf180mcu_ic_1x0p5_sram_u8b9k_sram_array.sv")
