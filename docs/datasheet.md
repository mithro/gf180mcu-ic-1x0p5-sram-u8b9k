# gf180mcu_ic_1x0p5_sram_u8b9k Datasheet

GF180MCU 1x0.5 SRAM Test Chip - 9KB unified 8-bit bus
## General Description

gf180mcu_ic_1x0p5_sram_u8b9k is an SRAM-based memory chip designed for the GF180MCU process.
It provides 9216 words of 8-bit storage using 18
embedded SRAM macros.

## Features

- 9216 bytes (73728 bits) total capacity
- 14-bit address bus
- 8-bit data bus
...
| addr[13:0] | Input | 14 | CMOS | Address bus |
...
The memory is organized as 9216 words of 8 bits each.
The address space spans from 0x0000 to 0x23FF.
...
Generated configuration: gf180mcu_ic_1x0p5_sram_u8b9k
- Slot: 1x0p5
- SRAM count: 18
